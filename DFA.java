...
public class DFA {
    ...
    public DFA() {
        ...
        acceptStates = new HashSet<>(); // A HashSet is a collection in Java that stores unique elements and provides efficient operations like add, remove, and contains using hashing. <>  are to define Generics as temp values
    ...
    private boolean accepts(String input) {
        ...
        for (char c : input.toCharArray()) { // loops through input chars
            ...
            currentState = transitions.get(transitionKey); // sets the current state to the key
        }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("[2] Create a DFA manually");
            System.out.println("[3] Test an input string");
